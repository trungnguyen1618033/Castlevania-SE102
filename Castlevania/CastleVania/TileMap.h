...
public:
	...
	TileMap(int ID, LPCSTR filePath_tex, LPCWSTR filePath_data, int map_width, int map_height);
...
public:
	void Add(int ID, LPCSTR filePath_tex, LPCWSTR filePath_data, int map_width, int map_height);
